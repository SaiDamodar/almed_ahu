            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Normal ranges by fan speed:', style: TextStyle(fontSize: 11, color: isDark ? Colors.white60 : Colors.black54)),
                  const SizedBox(height: 8),
                  _LegendItem(color: const Color(0xFF4CAF50), text: 'Low Speed: 40-55 Pa'),
                  const SizedBox(height: 8),
                  _LegendItem(color: const Color(0xFF4CAF50), text: 'Mid Speed: 60-90 Pa'),
                  const SizedBox(height: 8),
                  _LegendItem(color: const Color(0xFF4CAF50), text: 'High Speed: 90-110 Pa'),
                ],
              ),
            ),
            const SizedBox(height: 20),
