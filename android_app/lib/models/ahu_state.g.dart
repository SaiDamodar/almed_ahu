...
AhuState _$AhuStateFromJson(Map<String, dynamic> json) => AhuState(
      ...
      cpMode: json['cpMode'] as String? ?? 'dual',
      cpActive: (json['cpActive'] as num?)?.toInt() ?? 1,
      dualCpBothOn: json['dualCpBothOn'] as bool? ?? false,
...
Map<String, dynamic> _$AhuStateToJson(AhuState instance) => <String, dynamic>{
      ...
      'dualCpBothOn': instance.dualCpBothOn,
